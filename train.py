...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='yolov5m.pt', help='initial weights path')#哪种yolo结构？
    ...
    parser.add_argument('--batch-size', type=int, default=48, help='total batch size for all GPUs')#batchsize
